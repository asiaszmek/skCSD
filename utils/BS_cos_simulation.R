...
morpho<-matrix(as.numeric(as.matrix(read.table('coordsmid_x_y_z'))),ncol=3)
...
NewFolder<-paste0("skCSDreconstruct/") #where to save
...
write.table(MembMatr, "membcurr", row.names = FALSE, col.names = FALSE )
