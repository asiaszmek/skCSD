...
#DataFolder<-"/home/csdori/ksCSD_2014/trunk/simulation/Domi14/"#cell_Cos2/"#Domi_20ms/"#cell_D/" #gang_5x5_100/"
#KernelLocs<-"/home/csdori/ksCSD_2014/trunk/simulation/Domi14/kernelOut_4/"
DataFolder<-"/home/zoe/agy/ksCSD_2014/trunk/simulation/Domi14/"#cell_Cos2/"#Domi_20ms/"#cell_D/" #gang_5x5_100/"
KernelLocs<-"/home/zoe/agy/ksCSD_2014/trunk/simulation/Domi14/kernelOut_4/"
...
plot(1,type='n',xlim=XrangeEl,ylim=YrangeEl,xlab='x (um)',ylab='y (um)',main="Potential",asp=1)
...
szinskala2<-color.scale(c(rowMeans(what2Plot[,(TimeInstant-1):(TimeInstant+1)])),col=col1,zlim=c(-ExtVal*1.01,ExtVal*1.01))
symbols(elec[,xAEl],elec[,yAEl], circles=rep(25,dim(elec)[1]), add=TRUE, bg=szinskala2, fg=szinskala2, inches=FALSE)
...
text(elec[14:10,xAEl]+30,elec[14:10,yAEl], paste(c(1:5)),col=2:6)
...
col2<-ColoursDoriLFP(what2Plot)[[1]]
...
symbols(segmid[c(1:dimseg)[ToPlot],xA],segmid[c(1:dimseg)[ToPlot],yA], circles=c(diff(range(segstart[,xA]))/Plotwidth* abs(rowMeans(skCSD[,(TimeInstant-1):(TimeInstant+1)]))/ExtVal), add=TRUE, bg=colors()[182], fg=colors()[182], inches=FALSE)
...
#ffmpeg -framerate 5 -i CSD_MorphoCSD-%05d.png -c:v libx264  -pix_fmt yuv420p out.mp4
